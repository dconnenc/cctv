class ExperienceBlock < ApplicationRecord
  ...
  has_many :experience_video_submissions, dependent: :destroy
  ...
  # A synthetic question is a Family Feud question whose answers are generated by
  # the AI agent rather than gathered from participants. It is never shown to
  # participants and never accepts participant submissions.
  def synthetic_question?
    kind == QUESTION && [true, "true"].include?(payload&.dig("synthetic"))
  end
