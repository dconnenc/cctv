  ...
  ({ className, withIcons = false, ...props }, ref) => (
    ...
    >
      ...
      <SwitchPrimitives.Thumb
        className={cn(
          'pointer-events-none z-10 block h-4 w-4 rounded-full bg-background shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-4 data-[state=unchecked]:translate-x-0',
        )}
      />
    </SwitchPrimitives.Root>
  ),
